    ...
    $('.area').click(function(){
            ...
            if(cod !== ''){
                ...
                $.blockUI({ message: '<h4 class="thin" style="padding:20px;"><img src="../plantilla/img/standard/loaders/loading16.gif" /> Recuperando la informaci&oacute;n del Material, por favor espere...</h4>' });
                    $.get('procesos/material_info.php', {material: idMat[1], actividad:idMat[0]})
                    .done(function(data) {
                      $.unblockUI();
                      if (data !== '0'){
                         $.modal({
                            ...
                            buttons: {
                                ...
                                "Modificar Material": {
                                        classes:	"huge blue-gradient glossy",
                                        click:		function(win){ pagina = "material_modificar.php?idMat="+idMat[1]+"&idAct="+idMat[0]; location.href=pagina; }
                                }
                            },
