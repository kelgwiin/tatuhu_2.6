...
<!-- CEDULA-->
<div class="campoForm">C&eacute;dula <span class="obligatorio">*</span><br>
...
<table>
    ...
    <td>Nombre <span class="obligatorio">*</span><br>
       <input type="text" id="nombre" name="nombre" class="input" value=""><br>
       <div id="error-nombre" class="msjError"></div>
    </td>
    <td>Apellido <span class="obligatorio">*</span><br>
        <input type="text" name="apellido" class="input" value=""><br>
        <div id="error-apellido" class="msjError"></div>
    </td><br>
</tr>
<tr>
    <td>Fecha de Nacimiento <span class="obligatorio">*</span><br>
        <input type="text" name="fecha_nacimiento" class="input" id="fnac_id" value="">
...
<tr>
    <td>Tel&eacute;fono<br>
        <input type="text" name="telefono" class="input" id="tlf_id" value="">
        <br>
        <div id="error-telefono" class="msjError"></div>
    </td>
    <td>Correo<br>
        <input type="text" name="correo" class="input" value="">
        <br>
...
p_contenido('titulo_grande_1','Crear Usuario');
p_contenido('migajas','<a href="index.php">Inicio</a>><a href="#">Crear Usuario</a>');

p_con_pizarra(true);
p_contenido('pizarra','Registro de un nuevo Usuario');
