...
$query= 'SELECT id_tipo, tipo_actividad,nombre_sist FROM sist_actividad WHERE tipo_pedagogia="Lectura"';
$q0 = mysql_query($query); 
$tipos = "<option></option>";
 while($qa0=mysql_fetch_assoc($q0)){
...
<br> 
<div>
<form id="formulario" name="nuevaMarerial" action="">
<fieldset class="fieldset">
<legend class="legend">Datos del Material</legend>
<table>
   <tr> 
   <td>
        Nombre del Material<span class="obligatorio">*</span><br>
        <input type="text" class="input" name="nombre_material" id="nombre_material" maxlength="60"><br>
        <div id="error-nombre_material" class="msjError"></div>
   </td>
    <td>
        Retroalimentaci&oacute;n<span class="obligatorio">*</span><br>
        <textarea class="input" name="retroalimentacion" rows="4" cols="30" id="retroalimentacion"></textarea><br>
        <div id="error-retroalimentacion" class="msjError"></div><br>
        </td>   
   </tr>
   <tr>
    <td>
        Usuario <span class="obligatorio">*</span><br>
        <select class="select expandable-list" style="max-width:150px;" id="usuario" name="usuario">
    ...
    <td>
         Tipo de Material <span class="obligatorio">*</span><br>
...
p_js_agregar_archivo('plantilla/js/jsUsuarios/nuevoMaterial.js');
...
p_contenido('titulo_grande_1','Agregar Material');
p_contenido('migajas','<a href="index.php">Inicio</a>><a href="#">Agregar Material</a>');

p_con_pizarra(true);
p_contenido('pizarra','Registro de un nuevo Material');
