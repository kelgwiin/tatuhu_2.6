...
//Select de Estados
$queryEst= 'SELECT id_estado, estado FROM sist_estado WHERE id_pais="1"';
...
p_contenido('centro','
    <div id="centro">
<h3 class="thin">Registro de un nuevo Instituto Educativo</h3>
<div id="cprincipal">
...
<table>
    ...
    Tipo <span class="obligatorio">*</span><br><select name="tipo" class="select">
        <label>Tipo</label>
        <option name="tipo" value="PRE-ESCOLAR">Pre-escolar</option>
        <option name="tipo" value="BASICA MEDIA">B&aacute;sica Media</option>
        <option name="tipo" value="BASICA ALTA">B&aacute;sica Alta</option>
        <option name="tipo" value="BACHILLERATO">Bachillerato</option>
    </select>
</td></tr>
</table>
</fieldset><br>
<fieldset class="fieldset">
<legend class="legend">Direcci&oacute;n del Instituto <span class="obligatorio">*</span></legend>
<table>
    <tr>
...
');
//select validate[required] withClearFunctions expandable-list replacement fixedWidth select-styled-list tracked
...
p_contenido('titulo_grande_1','Nuevo Instituto Educativo');

p_con_pizarra(true);
p_contenido('pizarra','Agregar Instituto');
