...
(function($)
{
	...
	$.fn.wPaint.defaultSettings = {
		...
		fillStyle			 : 'transparent',			// starting fill style   ---MODIFICADO
		strokeStyle			 : '#3366CC',			// start stroke style   ---MODIFICADO
        ...
        menuTitles           : {                    // icon titles, replace any of the values to customize
                                    ...
                                    'text': 'Texto',
                                    'eraser': 'Borrador',
                                    'fillColor': 'Color de Relleno de las figuras',
                                    'lineWidth': 'Ancho de las lineas',
                                    'strokeColor': 'Color de las lineas',
                                    'bold': 'Negrita',
                                    'italic': 'Cursiva',
                                    'underline': 'Subrayado',
                                    'fontSize': 'Tama&ntilde;o de las letras',
