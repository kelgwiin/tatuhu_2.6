...
$("#pista").click(function(){
	...
	if (pistas_usadas == 3){
        ...
        $("#mensajessopa").html("<span style='color:rgb(180, 64, 0);'><img src='images/cross.png' style='margin-bottom: -5px;'> Ups! ya no tienes m&aacute;s pistas</span>");
    }
...
$("#sopa tr td").click(function(){
   ...
   if (posCorrecta !== false) {
      if(buscar(marcada)){
         for (var i = 0; i< tam; i++) {
            document.getElementById("sopa").getElementsByTagName("tr")[x[i]].getElementsByTagName("td")[y[i]].style.background = "#fff";
         ...
         $("#pistas tr td" +nombreClase).css("color","#004230"); 
         ...
         inc = 0;
         marcada = "";
         $("#mensajessopa").html("<span style='color:#004230;'><img src='../../images/accept.png' style='margin-bottom: -5px;'> &iexcl;Muy bien! </span>");
   ...
   if (inc > 1){
       for (var i =0; i< tam; i++) 
        ...
        y = [];
        if (inc !== 4000)
            $("#mensajessopa").html("<span style='color:rgb(180, 64, 0);'><img src='../../images/cross.png' style='margin-bottom: -5px;'> Ups! por ah&iacute; no est&aacute; la palabra</span>");
        else
            $("#mensajessopa").html("<span style='color:rgb(3, 85, 141);'><img src='../../images/nota.png'> &iexcl;&Aacute;nimo! est&aacute;s cerca</span>");
