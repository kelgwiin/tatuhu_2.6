...
function abrirVentana (url){
	window.open(url, "_blank", "width=1020, height=700 ,scrollbars=yes");
}
    ...
    switch(grado){
        ...
        case "6":
            ...
            if (componente=="GR" || componente=="GR#"){
                ...
                //Índice: Seleccione una actividad 
                $("#Lact").append('<ul class="1 acts">\
                   <li><a href="actividadesComunes/visorLibros.html?libro=LibroAmbiente&paginas=58&ancho=600&largo=300"><img src="images/empty.gif" />Lee y aprende: El ambiente</a></li>\
                    <li><a href="actividadesComunes/miraClasifica.html?&componente='+componente+'"><img src="images/empty.gif" />Mira y clasifica</a></li>\
                    <li><a href="actividadesComunes/pareo.html?numero=4"><img src="images/empty.gif" />Asocia la definici&oacute;n</a></li>\
                    \
                    </ul>\
            ...
            if (componente=="I" || componente=="I#"){
                ...
                $("#Lact").append('<ul class="1 acts">\
                            ...
                            <ul class="2 acts">\n\
                                ...
                                <li><a href="actividadesComunes/completaFrase.html?grado='+grado+'&area='+area+'&componente='+componente+'&nombre=completa_la_frase&titulo=Completa_la_Frase"><img src="images/empty.gif" />Completa la frase </a></li>\
...
***********************************************/
    ...
    switch(grado){
        ...
        case '6':
            //Gestión de Riesgos
            if (componente=="GR" || componente=="GR#"){
            $("#acordeon").append('<div><a href="#" class="item" id ="1"><div class="icon"><img src="images/mapas.png" /></div><span>Aprendamos sobre la educación vial</span></a></div>\
